 ...
 */
package hotel.view;
import hotel.model.utilisateur;
...
public class interfacetest extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if (jComboBox1.getSelectedIndex()== 1 ){
            Document admin = utilisateur.isAdmin(email , password);
            if(admin == null ) {
        ...
        if (jComboBox1.getSelectedIndex()== 2 ){
            ...
            String id = utilisateur.isClient(email, password);
             if(  id== null) {
    ...
    javax.swing.JOptionPane.showMessageDialog(null,
            ...
            javax.swing.JOptionPane.ERROR_MESSAGE);
                        ...
                        new userpage(id).setVisible(true);
         this.setVisible(false);
